...
public:
  ...
  void init_knowledge()
  {
    problem_expert_->addInstance(plansys2::Instance{"Rosbot", "robot"});
    problem_expert_->addInstance(plansys2::Instance{"wp_start", "waypoint"});
    ...
    problem_expert_->addPredicate(plansys2::Predicate("(robot_at Rosbot wp_start)"));
    problem_expert_->addPredicate(plansys2::Predicate("(connected wp_start wp1)"));
    problem_expert_->addPredicate(plansys2::Predicate("(connected wp1 wp_start)"));
      ...
      case STARTING:
        {
          ...
          problem_expert_->setGoal(plansys2::Goal("(and(robot_at Rosbot wp1))"));
      ...
      case PATROL_WP1:
        {
          ...
          if (!executor_client_->execute_and_check_plan() && executor_client_->getResult()) {
            if (executor_client_->getResult().value().success) {
              ...
              // Cleanning up
              problem_expert_->removePredicate(plansys2::Predicate("(robot_at Rosbot wp1)"));

              // Set the goal for next state
              problem_expert_->setGoal(plansys2::Goal("(and(robot_at Rosbot wp2))"));
      ...
      case PATROL_WP2:
        {
          ...
          if (!executor_client_->execute_and_check_plan() && executor_client_->getResult()) {
            if (executor_client_->getResult().value().success) {
              ...
              // Cleanning up
              problem_expert_->removePredicate(plansys2::Predicate("(robot_at Rosbot wp2)"));

              // Set the goal for next state
              problem_expert_->setGoal(plansys2::Goal("(and(robot_at Rosbot wp3))"));
      ...
      case PATROL_WP3:
        {
          ...
          if (!executor_client_->execute_and_check_plan() && executor_client_->getResult()) {
            if (executor_client_->getResult().value().success) {
              ...
              // Cleanning up
              problem_expert_->removePredicate(plansys2::Predicate("(robot_at Rosbot wp3)"));

              // Set the goal for next state
              problem_expert_->setGoal(plansys2::Goal("(and(robot_at Rosbot wp4))"));
      ...
      case PATROL_WP4:
        {
          ...
          if (!executor_client_->execute_and_check_plan() && executor_client_->getResult()) {
            if (executor_client_->getResult().value().success) {
              ...
              // Cleanning up
              problem_expert_->removePredicate(plansys2::Predicate("(robot_at Rosbot wp4)"));
