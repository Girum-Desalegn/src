  ...
  plansys2_msgs__srv__GetDomainTypes_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    plansys2_msgs__srv__GetDomainTypes_Request * data =
      (plansys2_msgs__srv__GetDomainTypes_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!plansys2_msgs__srv__GetDomainTypes_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          plansys2_msgs__srv__GetDomainTypes_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  plansys2_msgs__srv__GetDomainTypes_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    plansys2_msgs__srv__GetDomainTypes_Response * data =
      (plansys2_msgs__srv__GetDomainTypes_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!plansys2_msgs__srv__GetDomainTypes_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          plansys2_msgs__srv__GetDomainTypes_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
