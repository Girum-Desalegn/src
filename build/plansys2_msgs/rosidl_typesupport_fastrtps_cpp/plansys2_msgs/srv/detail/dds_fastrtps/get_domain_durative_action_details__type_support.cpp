...
{
  return max_serialized_size_GetDomainDurativeActionDetails_Request(full_bounded, 0);
}
...
{
  return max_serialized_size_GetDomainDurativeActionDetails_Response(full_bounded, 0);
}
