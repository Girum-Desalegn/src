  ...
  void * untyped_ros_message)
{
  ...
  // Field name: sub_types
  {
    ...
    if (!rosidl_runtime_c__String__Sequence__init(&ros_message->sub_types, size)) {
      return "failed to create array for field 'sub_types'";
    }
    auto array_ptr = ros_message->sub_types.data;
    for (size_t i = 0; i < size; ++i) {
      std::string tmp;
...
static size_t _Param__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_plansys2_msgs__msg__Param(
    full_bounded, 0);
}
