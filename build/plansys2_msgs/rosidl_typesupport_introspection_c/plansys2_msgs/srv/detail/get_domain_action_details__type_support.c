...
void GetDomainActionDetails_Request__rosidl_typesupport_introspection_c__GetDomainActionDetails_Request_init_function(
...
void GetDomainActionDetails_Request__rosidl_typesupport_introspection_c__GetDomainActionDetails_Request_fini_function(void * message_memory)
{
  plansys2_msgs__srv__GetDomainActionDetails_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember GetDomainActionDetails_Request__rosidl_typesupport_introspection_c__GetDomainActionDetails_Request_message_member_array[2] = {
  {
    "action",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers GetDomainActionDetails_Request__rosidl_typesupport_introspection_c__GetDomainActionDetails_Request_message_members = {
  ...
  GetDomainActionDetails_Request__rosidl_typesupport_introspection_c__GetDomainActionDetails_Request_message_member_array,  // message members
  GetDomainActionDetails_Request__rosidl_typesupport_introspection_c__GetDomainActionDetails_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  GetDomainActionDetails_Request__rosidl_typesupport_introspection_c__GetDomainActionDetails_Request_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t GetDomainActionDetails_Request__rosidl_typesupport_introspection_c__GetDomainActionDetails_Request_message_type_support_handle = {
  0,
  &GetDomainActionDetails_Request__rosidl_typesupport_introspection_c__GetDomainActionDetails_Request_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, plansys2_msgs, srv, GetDomainActionDetails_Request)() {
  if (!GetDomainActionDetails_Request__rosidl_typesupport_introspection_c__GetDomainActionDetails_Request_message_type_support_handle.typesupport_identifier) {
    GetDomainActionDetails_Request__rosidl_typesupport_introspection_c__GetDomainActionDetails_Request_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &GetDomainActionDetails_Request__rosidl_typesupport_introspection_c__GetDomainActionDetails_Request_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
void GetDomainActionDetails_Response__rosidl_typesupport_introspection_c__GetDomainActionDetails_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void GetDomainActionDetails_Response__rosidl_typesupport_introspection_c__GetDomainActionDetails_Response_fini_function(void * message_memory)
{
  plansys2_msgs__srv__GetDomainActionDetails_Response__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember GetDomainActionDetails_Response__rosidl_typesupport_introspection_c__GetDomainActionDetails_Response_message_member_array[3] = {
  {
    "action",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers GetDomainActionDetails_Response__rosidl_typesupport_introspection_c__GetDomainActionDetails_Response_message_members = {
  "plansys2_msgs__srv",  // message namespace
  "GetDomainActionDetails_Response",  // message name
  3,  // number of fields
  sizeof(plansys2_msgs__srv__GetDomainActionDetails_Response),
  GetDomainActionDetails_Response__rosidl_typesupport_introspection_c__GetDomainActionDetails_Response_message_member_array,  // message members
  GetDomainActionDetails_Response__rosidl_typesupport_introspection_c__GetDomainActionDetails_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  GetDomainActionDetails_Response__rosidl_typesupport_introspection_c__GetDomainActionDetails_Response_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t GetDomainActionDetails_Response__rosidl_typesupport_introspection_c__GetDomainActionDetails_Response_message_type_support_handle = {
  0,
  &GetDomainActionDetails_Response__rosidl_typesupport_introspection_c__GetDomainActionDetails_Response_message_members,
  get_message_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, plansys2_msgs, srv, GetDomainActionDetails_Response)() {
  GetDomainActionDetails_Response__rosidl_typesupport_introspection_c__GetDomainActionDetails_Response_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, plansys2_msgs, msg, Action)();
  if (!GetDomainActionDetails_Response__rosidl_typesupport_introspection_c__GetDomainActionDetails_Response_message_type_support_handle.typesupport_identifier) {
    GetDomainActionDetails_Response__rosidl_typesupport_introspection_c__GetDomainActionDetails_Response_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &GetDomainActionDetails_Response__rosidl_typesupport_introspection_c__GetDomainActionDetails_Response_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
