...
{
  new (message_memory) cascade_lifecycle_msgs::msg::State(_init);
}

void State_fini_function(void * message_memory)
{
  auto typed_message = static_cast<cascade_lifecycle_msgs::msg::State *>(message_memory);
  typed_message->~State();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember State_message_member_array[2] = {
  {
    ...
    offsetof(cascade_lifecycle_msgs::msg::State, state),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cascade_lifecycle_msgs::msg::State, node_name),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers State_message_members = {
  ...
  "State",  // message name
  2,  // number of fields
  sizeof(cascade_lifecycle_msgs::msg::State),
...
{
  return &::cascade_lifecycle_msgs::msg::rosidl_typesupport_introspection_cpp::State_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cascade_lifecycle_msgs, msg, State)() {
  return &::cascade_lifecycle_msgs::msg::rosidl_typesupport_introspection_cpp::State_message_type_support_handle;
}
