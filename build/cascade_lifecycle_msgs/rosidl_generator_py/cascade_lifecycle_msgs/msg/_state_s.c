...
bool cascade_lifecycle_msgs__msg__state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cascade_lifecycle_msgs.msg._state.State", full_classname_dest, 39) == 0);
  }
  cascade_lifecycle_msgs__msg__State * ros_message = _ros_message;
  {  // state
...
PyObject * cascade_lifecycle_msgs__msg__state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("cascade_lifecycle_msgs.msg._state");
